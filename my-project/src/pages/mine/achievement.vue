<template>
	<view class="page">
		<view class="hero">
			...
			<view class="hero-top"><view><text class="hero-title">我的成就</text><text class="hero-sub">每一次坚持，都值得被记录</text></view><view class="hero-medal">🏅</view></view>
