<template>
  <view class="page">
    ...
    <view v-else class="map-board">
      ...
      <view v-for="(level, index) in levels" :key="level.key" class="map-stop" :class="[positionClass(index), level.status, { boss: level.is_boss, 'has-module': !!moduleInfo(index) }]">
...
export default {
  ...
  methods: {
    ...
    segmentClass(index) {
      const direction = ['line-right', 'line-left', 'line-left', 'line-right'][index % 4]
      return [2, 5, 8].includes(index) ? direction + ' line-long' : direction
    },
    moduleInfo(index) {
...
<style>
.page{box-sizing:border-box;min-height:100vh;padding:22rpx 22rpx 52rpx;background:linear-gradient(180deg,#edf5f6 0,#f7f5f0 430rpx)}.hero{padding:27rpx;border-radius:27rpx;background:linear-gradient(135deg,#1f3a5f,#246d78);color:#fff;box-shadow:0 13rpx 30rpx rgba(31,58,95,.2)}.hero-main{display:flex;align-items:flex-start;justify-content:space-between}.hero-title{display:block;font-size:38rpx;font-weight:900}.hero-sub{display:block;margin-top:7rpx;font-size:21rpx;color:rgba(255,255,255,.7)}.hero-medal{display:flex;align-items:center;justify-content:center;width:66rpx;height:66rpx;border-radius:19rpx;background:rgba(255,255,255,.12);font-size:35rpx}.hero-progress{height:8rpx;margin-top:22rpx;overflow:hidden;border-radius:8rpx;background:rgba(255,255,255,.16)}.hero-progress view{height:100%;border-radius:8rpx;background:#70d1c5}.hero-stats{display:flex;margin-top:18rpx}.hero-stats view{flex:1;text-align:center}.hero-stats text:first-child{display:block;font-size:28rpx;font-weight:900}.hero-stats text:last-child{display:block;margin-top:2rpx;font-size:18rpx;color:rgba(255,255,255,.65)}.route-heading{display:flex;align-items:flex-end;justify-content:space-between;margin:28rpx 6rpx 15rpx}.route-title{display:block;font-size:31rpx;font-weight:900;color:#213f61}.route-sub{display:block;margin-top:4rpx;font-size:21rpx;color:#89969f}.route-count{padding:7rpx 14rpx;border-radius:18rpx;background:#d9f4ef;color:#0b9487;font-size:20rpx;font-weight:800}.state{padding:120rpx 0;text-align:center;color:#84919c;font-size:25rpx}.map-board{position:relative;overflow:hidden;padding:8rpx 18rpx 65rpx;border-radius:30rpx;background:linear-gradient(180deg,#dff2ef,#e9f4e7 58%,#f4ecd9);box-shadow:inset 0 0 0 2rpx rgba(255,255,255,.72),0 8rpx 25rpx rgba(46,84,94,.09)}.map-stop{position:relative;height:220rpx}.map-stop.has-module{padding-top:105rpx}.module-banner{position:absolute;z-index:5;top:12rpx;left:4rpx;right:4rpx;display:flex;align-items:center;box-sizing:border-box;height:84rpx;padding:13rpx 16rpx;border-radius:22rpx;background:linear-gradient(100deg,#1f3a5f,#24717a);color:#fff;box-shadow:0 8rpx 18rpx rgba(31,58,95,.17)}.module-icon{display:flex;align-items:center;justify-content:center;width:54rpx;height:54rpx;border-radius:15rpx;background:rgba(255,255,255,.14);font-size:28rpx}.module-copy{flex:1;min-width:0;margin-left:14rpx}.module-copy text:first-child{display:block;font-size:25rpx;font-weight:900}.module-copy text:last-child{display:block;margin-top:3rpx;font-size:18rpx;color:rgba(255,255,255,.67)}.module-progress{padding:6rpx 11rpx;border-radius:15rpx;background:rgba(255,255,255,.14);font-size:19rpx;font-weight:800}.node-wrap{position:absolute;z-index:3;top:50%;display:flex;flex-direction:column;align-items:center;width:190rpx;transform:translate(-50%,-50%)}.node-left .node-wrap{left:25%}.node-center .node-wrap{left:50%}.node-right .node-wrap{left:75%}.level-node{position:relative;z-index:2;display:flex;align-items:center;justify-content:center;width:91rpx;height:91rpx;border:11rpx solid rgba(255,255,255,.72);border-radius:50%;background:#1f3a5f;box-shadow:0 10rpx 0 #142b47,0 14rpx 23rpx rgba(27,55,71,.24)}.node-icon{font-size:35rpx;color:#fff}.locked .level-node{filter:grayscale(1);opacity:.63;background:#82979b;box-shadow:0 10rpx 0 #617478}.passed .level-node{background:#e7903d;box-shadow:0 10rpx 0 #b95d29}.boss .level-node{width:104rpx;height:104rpx;background:#d97835;box-shadow:0 11rpx 0 #a64b25}.node-title{margin-top:14rpx;padding:5rpx 13rpx;border-radius:14rpx;background:rgba(255,255,255,.78);color:#304e62;font-size:21rpx;font-weight:900;white-space:nowrap}.node-status{margin-top:5rpx;color:#819296;font-size:17rpx}.node-stars{margin-top:4rpx;color:#ef973d;font-size:19rpx;letter-spacing:2rpx}.node-stars .dim{color:#c9d2d1}.pulse{position:absolute;top:30rpx;width:125rpx;height:125rpx;border:5rpx solid rgba(13,148,136,.35);border-radius:50%;animation:pulse 1.7s ease-out infinite}.route-segment{position:absolute;z-index:1;top:50%;width:0;height:278rpx;border-left:7rpx dashed rgba(69,112,104,.35);transform-origin:top center}.node-left .route-segment{left:25%}.node-center .route-segment{left:50%}.node-right .route-segment{left:75%}.line-right{transform:rotate(-38deg)}.line-left{transform:rotate(38deg)}.line-long{height:316rpx}.line-long.line-right{transform:rotate(-30deg)}.line-long.line-left{transform:rotate(30deg)}.scenery{position:absolute;z-index:0;opacity:.11;filter:grayscale(1)}.scenery-tree{top:640rpx;right:-18rpx;font-size:145rpx}.scenery-bear{top:1340rpx;left:-22rpx;font-size:155rpx}.scenery-cloud{top:980rpx;right:10rpx;font-size:125rpx}.finish{position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;margin-top:18rpx;color:#7b6d4e}.finish-cup{display:flex;align-items:center;justify-content:center;width:84rpx;height:84rpx;margin-bottom:12rpx;border-radius:50%;background:#fff2c7;font-size:42rpx;box-shadow:0 8rpx 17rpx rgba(129,99,47,.14)}.finish text:nth-child(2){font-size:23rpx;font-weight:900}.finish text:last-child{margin-top:4rpx;font-size:18rpx;color:#9b9077}@keyframes pulse{0%{transform:scale(.75);opacity:1}100%{transform:scale(1.3);opacity:0}}
</style>